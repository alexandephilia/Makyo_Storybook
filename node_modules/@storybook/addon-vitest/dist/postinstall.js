import CJS_COMPAT_NODE_URL_0pez86jdd19 from 'node:url';
import CJS_COMPAT_NODE_PATH_0pez86jdd19 from 'node:path';
import CJS_COMPAT_NODE_MODULE_0pez86jdd19 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_0pez86jdd19.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_0pez86jdd19.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_0pez86jdd19.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-PRK46PN4.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-U5EEILPB.js";
import {
  require_dist
} from "./_node-chunks/chunk-K7CN2KUU.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-E56NBGSU.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-KP7TRIQJ.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-GW5VSNXJ.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-DLTPNJGH.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-ZCFZNT6F.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-NVDXV3JM.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-H634PRFK.js");
    default:
