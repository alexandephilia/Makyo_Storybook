import CJS_COMPAT_NODE_URL_5rnw4c4z01 from 'node:url';
import CJS_COMPAT_NODE_PATH_5rnw4c4z01 from 'node:path';
import CJS_COMPAT_NODE_MODULE_5rnw4c4z01 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_5rnw4c4z01.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_5rnw4c4z01.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_5rnw4c4z01.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-B2Q6ZUNK.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-JIS5UEVK.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-6J3HX2NC.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-WLHK7KSX.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
