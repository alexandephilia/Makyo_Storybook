...
import {
  compile
} from "./chunk-LBZ2JYGS.js";
import "./chunk-HVQSI5GY.js";
import "./chunk-AYC45HRV.js";
import {
  __commonJS,
  __toESM
} from "./chunk-B2Q6ZUNK.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-JIS5UEVK.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-6J3HX2NC.js")).default;
  return {
